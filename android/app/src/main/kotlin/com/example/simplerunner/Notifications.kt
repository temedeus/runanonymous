...
object Notifications {
    ...
    private const val CHANNEL_NAME_BACKGROUND_SERVICE = "Running performance background service"
    ...
    fun buildForegroundNotification(context: Context): Notification {
        return NotificationCompat
                ...
                .setContentTitle("Simple Runner")
                .setContentText("Tracking running speed...")
                .build()
    }
}